...
use App\Services\Disk\CrmFileResolver;
use App\Services\Disk\DiskLocalStorage;
use App\Services\Disk\ListDocumentFieldMap;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Storage;
use Throwable;

class BitrixDiskSyncService
{
    private const IBLOCK_TYPE_ID = 'lists';

    public function __construct(
        private readonly BitrixWebhookClient $webhookClient,
        private readonly ListDocumentFieldMap $fieldMap,
        private readonly CrmFileResolver $crmFileResolver,
        private readonly DiskLocalStorage $localStorage,
    ) {}
    ...
    private function syncElement(int $listId, array $item, array $map): array
    {
        ...
        $markedDeleted = $this->markMissingAsDeleted($listId, $elementId, $active);
     ...
     */
    private function markMissingAsDeleted(int $listId, int $elementId, array $active): int
    {
