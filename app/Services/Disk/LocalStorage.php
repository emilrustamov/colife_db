...
class LocalStorage
{
    ...
    private function ensureWebDir(string $relativeDirectory): void
    {
        $disk = Storage::disk('local');
    ...
    private function deletedFileName(string $fieldSlug, int $fileId, string $originalName, ?int $version): string
    {
        ...
        return $this->versionedName($base, $version);
    }

    private function versionedName(string $fileName, int $version): string
    {
