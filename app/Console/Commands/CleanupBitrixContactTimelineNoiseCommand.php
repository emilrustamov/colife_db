...
class CleanupBitrixContactTimelineNoiseCommand extends Command
{
    ...
    protected $description = 'Delete noisy bitrix.contact.updated timeline events with technical-only diffs';
