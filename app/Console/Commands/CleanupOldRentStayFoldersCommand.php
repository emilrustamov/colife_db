...
class CleanupOldRentStayFoldersCommand extends Command
{
    ...
    protected $description = 'Remove old-format stay folders under Appartments/*/Rent (dates before surname)';
     ...
     */
    public function handle(BitrixWebhookClient $client): int
    {
