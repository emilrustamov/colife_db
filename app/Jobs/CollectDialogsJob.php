...
use App\Services\ChatAppApiService;
use App\Services\ChatAppDialogBalanceAlertService;
use Illuminate\Foundation\Bus\Dispatchable;
use Illuminate\Support\Carbon;

class CollectDialogsJob
{
    use Dispatchable;
    ...
    public function handle(
        ChatAppApiService $chatAppApiService,
        ChatAppDialogBalanceAlertService $alertService
    ): void {
